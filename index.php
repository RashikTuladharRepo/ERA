...
<!--        </div>-->
        ...
        <div class="col-md-12 clearfix">
            <p class="text-justify segeo font18">
                ...
                <br><br>
                We have a team of qualified and certified IT Professional with variety of expertise, skills and
                experiences. Our Entire team is always working towards utmost quality service with high degree of
                professionalism. Our main strategy is to understand the need of the client and provide the best solution
                by deploying the cutting edge technology. We have expertise and experiences in Software and Web
                Development, Computer Hardware Support, Computer Network Support and Multimedia Presentation
                Support.Since our inception we have got an overwhelming support and which has encouraged us to be more
                dedicated and responsible in our profession.
            </p>
        </div>
    </div>
</div>
...
<div class="section" id="eraservices">
    <div class="container">
        ...
        <div class="row segeo font16">
            <div class="col-md-3 col-sm-12 services-columns">
